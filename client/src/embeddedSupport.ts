...
export function isInsideStyleRegion(
	...
	console.log("🚀 --> isInsideStyleRegion:");
...
export function getCSSVirtualContent(
	...
	console.log("🚀 --> getCSSVirtualContent:");
...
export function getDocumentRegions(
	...
	console.log("🚀 --> getDocumentRegions:");
	// debugger;
	// console.log("🚀 --> file: embeddedSupport.ts:151 --> languageService:", languageService);
	const regions: EmbeddedRegion[] = [];
...
function getLanguageRanges(
	...
	console.log("🚀 --> file: embeddedSupport.ts:242 --> document:");
